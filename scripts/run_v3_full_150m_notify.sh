...
RUN_NAME="${RUN_NAME:-v3_full_1b_plus_150m_1024}"
...
echo "=== SoloLLM v3 full 1B 150M run ==="
...
details = []
title = "SoloLLM v3 full 1B run complete" if status == 0 else "SoloLLM v3 full 1B run failed"
...
if summary_path.exists():
    ...
    details.append(f"{tokens / 1_000_000:.1f}M tok")
    if elapsed:
