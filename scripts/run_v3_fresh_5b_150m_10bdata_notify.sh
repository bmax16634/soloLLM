...
RUN_NAME="${RUN_NAME:-v3_fresh_5b_plus_150m_1024_10bdata}"
...
echo "=== SoloLLM v3 fresh 5B 150M run on 10B data ==="
...
details = []
title = "SoloLLM v3 fresh 5B run complete" if status == 0 else "SoloLLM v3 fresh 5B run failed"
...
if summary_path.exists():
    ...
    details.append(f"{tokens / 1_000_000_000:.2f}B tok")
    if elapsed:
